...
function DocSidebarDesktop({path, sidebar, onCollapse, isHidden, onDocItemClick}: Props) {
    ...
    <div
      ...
      <nav
        ...
        <ul className={clsx(ThemeClassNames.docs.docSidebarMenu, 'menu__list')}>
          <DocSidebarItems items={sidebar} onItemClick={onDocItemClick} activePath={path} level={1} />
        </ul>
      </nav>
